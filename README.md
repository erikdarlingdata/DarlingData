...
| @escape_brackets          | bit            | set this bit to 1 to search for query text containing square brackets                            | 0 or 1                                                                             | 0                                                |
| @escape_character         | nchar          | sets the ESCAPE character, defaults to the SQL standard backslash (`\`) character                | some escape character, SQL standard is backslash (`\`)                             | \                                                |
