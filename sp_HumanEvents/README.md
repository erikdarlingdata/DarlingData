...
| @query_sort_order      | nvarchar       | when you use the "query" event, lets you choose which metrics to sort results by             | "cpu", "reads", "writes", "duration", "memory", "spills", "event_time", and you can add "avg" to sort by averages, e.g. "avg cpu" | "cpu"                                           |
